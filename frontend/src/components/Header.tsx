...
const Header: React.FC<HeaderProps> = ({
    ...
    return (
        <header className="w-full flex flex-col md:flex-row md:items-center justify-between gap-4 py-4 px-2 mb-6">
            ...
            <div className="flex items-center gap-4 flex-1">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="lg:hidden p-2.5 hover:bg-slate-100 dark:hover:bg-white/5 rounded-xl transition-colors text-slate-500 dark:text-slate-400 border border-slate-100 dark:border-white/10 shadow-sm"
                    >
            ...
            <div className="flex items-center gap-2 sm:gap-4 ml-auto">
                {/* Messages */}
                <button
                    className="p-2.5 sm:p-3 rounded-2xl bg-indigo-100 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20 shadow-sm hover:shadow-md hover:bg-indigo-200 dark:hover:bg-indigo-500/20 hover:translate-y-[-1px] transition-all relative group"
                    title="Messages"
                >
                    <Mail className="w-4 h-4 sm:w-5 h-5 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform" />
                    <span className="absolute top-2.5 right-2.5 w-2 h-2 rounded-full bg-indigo-600 border-2 border-white dark:border-[#0B0F19]" />
                </button>

                {/* Notifications */}
                <button
                    className="p-2.5 sm:p-3 rounded-2xl bg-orange-100 dark:bg-orange-500/10 border border-orange-200 dark:border-orange-500/20 shadow-sm hover:shadow-md hover:bg-orange-200 dark:hover:bg-orange-500/20 hover:translate-y-[-1px] transition-all relative group"
                    title="Notifications"
                >
                    <Bell className="w-4 h-4 sm:w-5 h-5 text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform" />
                    <span className="absolute top-2.5 right-2.5 w-2 h-2 rounded-full bg-red-600 border-2 border-white dark:border-[#0B0F19]" />
                </button>

                {/* Settings */}
                <button
                    className="p-2.5 sm:p-3 rounded-2xl bg-violet-100 dark:bg-violet-500/10 border border-violet-200 dark:border-violet-500/20 shadow-sm hover:shadow-md hover:bg-violet-200 dark:hover:bg-violet-500/20 hover:translate-y-[-1px] transition-all group"
                    title="Settings"
                >
                ...
                <div className="flex items-center gap-2 sm:gap-3 pl-1 sm:pl-2 group cursor-pointer">
                    ...
                    <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-slate-900 border-2 border-white dark:border-white/10 shadow-lg overflow-hidden shrink-0 group-hover:scale-105 transition-transform">
                        <img
