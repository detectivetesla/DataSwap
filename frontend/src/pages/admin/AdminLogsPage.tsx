...
const AdminLogsPage: React.FC = () => {
    ...
    const logs = [
        { id: 1, type: 'auth', level: 'success', message: 'Admin login successful from IP 192.168.1.1', time: '2 mins ago', user: 'Admin' },
        { id: 2, type: 'bundle', level: 'info', message: 'Data Bundle "MTN 50GB" updated', time: '14 mins ago', user: 'Admin' },
        { id: 3, type: 'system', level: 'warning', message: 'API response time increased (450ms)', time: '45 mins ago', user: 'System' },
        { id: 4, type: 'auth', level: 'error', message: 'Multiple failed login attempts detected', time: '1 hour ago', user: 'Security' },
        { id: 5, type: 'order', level: 'success', message: 'New order #90210 processed successfully', time: '2 hours ago', user: 'Customer' },
        { id: 6, type: 'user', level: 'info', message: 'New user "John Doe" registered', time: '3 hours ago', user: 'Public' },
        { id: 7, type: 'system', level: 'success', message: 'Database backup completed', time: '5 hours ago', user: 'Cron' },
    ];
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <button className="flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-red-500/5 border border-red-500/10 text-red-500 font-black text-sm hover:bg-red-500 hover:text-white transition-all">
                                ...
                                <tr key={log.id} className="hover:bg-slate-50/50 dark:hover:bg-white/[0.01] transition-colors group">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="font-bold text-sm text-slate-600 dark:text-slate-400">{log.user}</span>
                                        </div>
                                    </td>
                                    <td className="px-8 py-6">
                                        <p className="font-bold text-slate-900 dark:text-white text-sm">{log.message}</p>
                                    </td>
                                    <td className="px-8 py-6">
