...
import { Download, Search, ChevronRight, ArrowUpRight } from 'lucide-react';
                                ...
                                <tr key={item.id} className="hover:bg-slate-100 dark:hover:bg-white/5 transition-colors group">
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="font-black text-black dark:text-white text-lg">GH₵ {(150 * item.id).toFixed(2)}</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                        <span className="px-3 py-1 rounded-lg bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold">Paystack</span>
                                    </td>
                                    <td className="px-6 py-5 font-mono text-sm text-slate-400 dark:text-slate-600">DEP-7742189{item.id}</td>
                                    <td className="px-6 py-5">
                                        <span className={cn(
                                    ...
                                    <td className="px-6 py-5 text-xs font-medium text-slate-500 dark:text-slate-500 uppercase tracking-tight">Jan 1{item.id}, 2026 10:30 AM</td>
