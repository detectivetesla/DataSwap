                ...
                {(Object.keys(networkConfig) as Network[]).map((network) => {
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                'relative p-8 rounded-3xl bg-white dark:bg-white/[0.02] border-2 transition-all group',
                        ...
                        >
                            <div className="flex flex-col items-center gap-4">
                                <div className={cn('w-20 h-20 rounded-2xl flex items-center justify-center', config.color)}>
                                    <img src={config.logo} alt={network} className="w-14 h-14 object-contain" />
                                </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-black text-black dark:text-white">
                                    {selectedNetwork} Data Bundle
                                </h2>
                                <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">
                                    Purchase {selectedNetwork} data bundles for single or multiple recipients
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-primary/10 border border-primary/20">
                        ...
                        <div className="text-left">
                            <p className="text-xs font-bold text-slate-600 dark:text-slate-400">Wallet Balance</p>
